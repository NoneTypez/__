import { IIcons, IHeadersValues, ISubMenus } from "./interfaces";
...
const forms: Array<object> = [
  { name: "name", placeholder: "введиите имя" },
...
const subMenus: ISubMenus = {
  ...
  projects: [
    ...
    { text: "PROJECT5555", onclick: () => console.log("Project5 clicked") },
    { text: "PROJECT5555", onclick: () => console.log("Project5 clicked") },
    { text: "PROJECT5555", onclick: () => console.log("Project5 clicked") },
    { text: "PROJECT5555", onclick: () => console.log("Project5 clicked") },
    { text: "PROJECT5555", onclick: () => console.log("Project5 clicked") },
...
export { icons, testData, forms, subMenus };
