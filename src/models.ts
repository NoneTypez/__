...
const subMenus: ISubMenus = {
  ...
  projects: [
    { text: "PROJECT1", to: "/project1" },
    { text: "PROJECT2", to: "/project2" },
    { text: "PROJECT3", to: "/project3" },
    { text: "PROJECT4", to: "/project4" },
    { text: "PROJECT5555", to: "/project5" },
    { text: "PROJECT5555", to: "/project6" },
  ],
  scripts: [
    { text: "SCRIPT1", to: "/script1" },
    { text: "SCRIPT2", to: "/script2" },
    { text: "SCRIPT3", to: "/script3" },
    { text: "SCRIPT4", to: "/script4" },
    { text: "SCRIPT5", to: "/script5" },
  ],
  other: [
    { text: "GITCOIN", to: "/gitcoin" },
    { text: "SNAPSHOT", to: "/snapshot" },
    { text: "OTHER1", to: "/other1" },
  ],
  table: [],
};

const EVMWalletsData = [
  {
    id: 1,
  ...
  {
    id: 2,
    address: "0x81222Ad60Ea4b5A26b7675E9DA1E5071B83954c7",
    balance: "100",
  },
  {
    id: 3,
    address: "0x8e6914A34AC91F0e8DC9C9aa4BE60729230b6919",
    balance: "400",
  },
  {
    id: 4,
    address: "0x69A11D2E35954614738F8964B201433C8359F085",
    balance: "14542",
  },
  {
    id: 5,
    address: "0xe897373c6f24B814B8c256D850126597C7E29f1D",
    balance: "523523",
  },
  {
    id: 6,
